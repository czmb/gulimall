...
import com.atguigu.gulimall.ums.service.WmsWareInfoService;
...
@Api(tags = "仓库信息 管理")
@RestController
@RequestMapping("ums/wmswareinfo")
public class WmsWareInfoController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('ums:wmswareinfo:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('ums:wmswareinfo:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('ums:wmswareinfo:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('ums:wmswareinfo:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('ums:wmswareinfo:delete')")
