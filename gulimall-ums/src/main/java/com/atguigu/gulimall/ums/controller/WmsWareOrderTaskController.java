...
import com.atguigu.gulimall.ums.service.WmsWareOrderTaskService;
...
@Api(tags = "库存工作单 管理")
@RestController
@RequestMapping("ums/wmswareordertask")
public class WmsWareOrderTaskController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('ums:wmswareordertask:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('ums:wmswareordertask:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('ums:wmswareordertask:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('ums:wmswareordertask:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('ums:wmswareordertask:delete')")
