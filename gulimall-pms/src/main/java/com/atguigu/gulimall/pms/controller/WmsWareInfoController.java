...
import com.atguigu.gulimall.pms.service.WmsWareInfoService;
...
@Api(tags = "仓库信息 管理")
@RestController
@RequestMapping("pms/wmswareinfo")
public class WmsWareInfoController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('pms:wmswareinfo:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('pms:wmswareinfo:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('pms:wmswareinfo:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('pms:wmswareinfo:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('pms:wmswareinfo:delete')")
