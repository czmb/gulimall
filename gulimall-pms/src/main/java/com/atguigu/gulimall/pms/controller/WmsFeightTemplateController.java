...
import com.atguigu.gulimall.pms.service.WmsFeightTemplateService;
...
@Api(tags = "运费模板 管理")
@RestController
@RequestMapping("pms/wmsfeighttemplate")
public class WmsFeightTemplateController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('pms:wmsfeighttemplate:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('pms:wmsfeighttemplate:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('pms:wmsfeighttemplate:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('pms:wmsfeighttemplate:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('pms:wmsfeighttemplate:delete')")
